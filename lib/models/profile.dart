Map<String, String> profile = {
  ...
  'bio': 'Interested in Deep learning, App development',
};

Map<String, List> skills = {
  'language': ['Dart', 'Python', 'Swift'],
  'language_percentage': [0.8, 0.8, 0.1],
  'framework': ['Flutter', 'PyTorch'],
  'framework_percentage': [0.85, 0.7],
};

List<Map<String, String>> workExperience = [
  {
    'organization': 'ART Lab',
    'position': 'App developer',
  ...
  {
    'organization': 'Builton',
    'position': 'Intern',
    'date': 'Jan. 2020 ‐ Feb. 2020',
  },
  {
    'organization': 'Genesis Lab',
    'position': 'Intern',
